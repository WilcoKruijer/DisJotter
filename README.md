...
On the folder you saved the extension create a python virtual environment.  
```bash
python3 -m venv venv
...
When you start JupyterLab you'll see at the bottom of the luncher page the LifeWatch VRE section
...
When this is done repeat the process for all of the cells. Each step takes aproximatlly 5 minutes.
...
From the Experimentlauncherr you can see under the Local Catalog the containerized cells: s1,s2,s3.
