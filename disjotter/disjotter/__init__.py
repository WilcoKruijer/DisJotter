...
from .backend.handlers.hello_world_handler import \
    DeterminePackagesHandler, CommandHandler, InspectHandler
...
def load_jupyter_server_extension(nbapp):
    ...
    determine_pattern = url_path_join(base, '/dj/notebook/(.*)/requirements')
    ...
    web_app.add_handlers(host_pattern, [
        ...
        (determine_pattern, DeterminePackagesHandler),
